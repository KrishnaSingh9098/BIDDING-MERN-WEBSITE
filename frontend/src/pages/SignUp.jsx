...
const SignUp = () => {
  ...
  const [rajorPayAccountNumber, setRajorPayAccountNumber] = useState("");
  ...
  formData.append("rajorPayAccountNumber", rajorPayAccountNumber), // Make sure this is populated correctly
  formData.append("paypalEmail", paypalEmail));
  if (role === "Auctioneer" && !rajorPayAccountNumber) {
    alert("Please provide a valid Razorpay account number.");
    return;
  }
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <label className="text-[16px] text-stone-600 font-semibold">
                  rozorPay And Paypal Details
                </label>
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  <input
                    type="number"
                    value={rajorPayAccountNumber}
                    placeholder="Easypaisa Account Number"
                    onChange={(e) => setRajorPayAccountNumber(e.target.value)}
                    className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none sm:flex-1"
                    disabled={role === "Bidder"}
                  />
                  <input
